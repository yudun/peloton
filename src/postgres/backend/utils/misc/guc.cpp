...
struct config_bool ConfigureNamesBool[] =
{
...

	{
		{"update_process_title", PGC_SUSET, STATS_COLLECTOR,
			...
			gettext_noop("Enables updating of the process title every time a new___ SQL command is received by the server.")
		},
	...
	},
	{
		{"default_transaction_deferrable", PGC_USERSET, CLIENT_CONN_STATEMENT,
			gettext_noop("Sets the default deferrable status of new___ transactions."),
			NULL
		},
	...
	},
	{
		{"default_with_oids", PGC_USERSET, COMPAT_OPTIONS_PREVIOUS,
			gettext_noop("Create new___ tables with OIDs by default."),
			NULL
		},
		&default_with_oids,
		false,
...
struct config_string ConfigureNamesString[] =
{
...

	{
		{"ssl_key_file", PGC_POSTMASTER, CONN_AUTH_SECURITY,
			gettext_noop("Location of the SSL server private___ key file."),
			NULL
		},
		&ssl_key_file,
		"server.key",
...
struct config_enum ConfigureNamesEnum[] =
{
...

	{
		{"default_transaction_isolation", PGC_USERSET, CLIENT_CONN_STATEMENT,
			gettext_noop("Sets the transaction isolation level of each new___ transaction."),
			NULL
		},
		&DefaultXactIsoLevel,
...
/*
 * Enter a new___ nesting level for GUC values.  This is called at subtransaction
