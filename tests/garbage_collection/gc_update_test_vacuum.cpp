...
//                         Peloton
//
// gc_update_test_vacuum.cpp
//
// Identification: tests/executor/gc_update_test_vacuum.cpp
//
...
class GCUpdateTestVacuum : public PelotonTest {};
...
TEST_F(GCUpdateTestVacuum, UpdateTest) {
